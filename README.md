...
Et si le match est nul ? --> ajout d'une fonction sum dans player.hpp qui permet de faire la somme des élements du arrayPlayer (si la somme des deux sommes = 9, le match est nul)
